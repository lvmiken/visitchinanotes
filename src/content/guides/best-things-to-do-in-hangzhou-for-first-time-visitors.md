---
title: "Best Things to Do in Hangzhou for First-Time Visitors"
description: "Find out which things to do in Hangzhou are actually worth your limited time, how to choose between West Lake, temple, tea-country, wetland, and old-street layers, and how to build a fuller first trip without rushing the city."
...
whoItsFor:
  - "first-time Hangzhou visitors choosing what deserves real trip time"
  - "travelers who want a sharper shortlist than a generic scenic-city roundup"
  - "readers trying to make Hangzhou feel rewarding without turning it into a rushed map exercise"
keyTakeaways:
...
faq:
  ...
  - question: "Is Hangzhou worth more than just a quick West Lake stop?"
    answer: "Usually yes, especially when the route has enough time to give Hangzhou one slower scenic day and one selective cultural or tea-country branch instead of treating it as only a fast photo stop from Shanghai."
---
...
If the bigger question still is whether Hangzhou belongs in the route at all, start with [Hangzhou for First-Time Visitors: When the City Is Worth More Than a Quick Add-On](/guides/hangzhou-first-time-guide/).
...
- one `real scenic anchor`, usually [West Lake](/places/west-lake/)
- one `selective cultural or tea-country branch`, usually [Lingyin Temple](/places/lingyin-temple/) or [Longjing Village](/places/longjing-village/)
- one `supporting symbolic lake-side stop`, usually [Leifeng Pagoda](/places/leifeng-pagoda/) or [Broken Bridge](/places/broken-bridge/)
- one `lighter urban or second-green-area layer`, usually [Hefang Street](/places/hefang-street/) or [Xixi Wetland](/places/xixi-wetland/) only if the stay has room
...
For many readers, [West Lake](/places/west-lake/) is the strongest single thing to do in Hangzhou.
...
If the live question already is not whether West Lake matters but how to use it well, the narrower next page is [West Lake in Hangzhou: Is It Worth More Than a Quick Loop?](/places/west-lake/).

If the lake day itself still needs structure, the cleaner execution page is [How to Plan West Lake in Hangzhou Without Rushing](/guides/hangzhou-west-lake-planning/).

## 2. Lingyin Temple is the strongest non-lake upgrade

[Lingyin Temple](/places/lingyin-temple/) is often the best second anchor when Hangzhou needs one more meaningful layer beyond scenery.
...
If the real question already has narrowed to the pagoda, the next page is [Leifeng Pagoda in Hangzhou: Is It Worth It for First-Time Visitors?](/places/leifeng-pagoda/).

If the real question already has narrowed to the classic northern-lake scene, the next page is [Broken Bridge in Hangzhou: Is It Worth It for First-Time Visitors?](/places/broken-bridge/).

## 5. Hefang Street is the easier urban support layer

[Hefang Street](/places/hefang-street/) usually is not the main reason to choose Hangzhou, but it often works well as a lighter supporting block.
...
If the live question already is whether this bigger green add-on really beats Lingyin, Longjing, or one easier city-side layer, the narrower next page is [Xixi Wetland in Hangzhou: Is It Worth It for First-Time Visitors?](/places/xixi-wetland/).
