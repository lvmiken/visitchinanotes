...
whoItsFor:
  - "first-time Chengdu visitors choosing between the city's two most common traditional-core stops"
  - "travelers who only have room for one old-street or atmosphere block"
  - "readers deciding whether the better answer is a shorter central stop or a fuller Wuhou Shrine and evening cluster"
keyTakeaways:
...
If the broader Chengdu shortlist is still open, start with [Best Things to Do in Chengdu for First-Time Visitors](/guides/best-things-to-do-in-chengdu-for-first-time-visitors/).
...
- choose **Jinli** if you want one fuller traditional-core block, especially if `Wuhou Shrine` already belongs in the route
...
Choose [Jinli in Chengdu: Is It Worth Visiting on a First Trip?](/places/jinli/) if you want:
...
- the stay is closer to `3 days` than a rushed `2 days`
...
Choose [Kuanzhai Alley in Chengdu: Is It Worth Visiting on a First Trip?](/places/kuanzhai-alley/) if you want:
...
If you are still testing that shorter version of the city, [How Many Days in Chengdu for First-Time Visitors](/guides/how-many-days-in-chengdu-for-first-time-visitors/) is the better companion page.
...
If the real question already is meal geography rather than the old-street choice itself, [Where to Eat in Chengdu for First-Time Visitors](/guides/where-to-eat-in-chengdu-for-first-time-visitors/) is the better next page.
...
If the bigger question is not only old streets but the whole evening structure, [What to Do in Chengdu at Night for First-Time Visitors](/guides/what-to-do-in-chengdu-at-night-for-first-time-visitors/) is the tactical page to keep open too.
...
- [Yulin](/places/yulin/)
- tea, food, and one slower neighborhood session
...
- read [Best Things to Do in Chengdu for First-Time Visitors](/guides/best-things-to-do-in-chengdu-for-first-time-visitors/) if the wider shortlist still is not set
- read [Kuanzhai Alley in Chengdu: Is It Worth Visiting on a First Trip?](/places/kuanzhai-alley/) if the shorter central atmosphere answer is starting to win
- read [Jinli in Chengdu: Is It Worth Visiting on a First Trip?](/places/jinli/) if the fuller traditional-core answer is starting to win
- read [Where to Eat in Chengdu for First-Time Visitors](/guides/where-to-eat-in-chengdu-for-first-time-visitors/) if the old-street choice is mostly clear and the meal geography is now the real question
- read [What to Do in Chengdu at Night for First-Time Visitors](/guides/what-to-do-in-chengdu-at-night-for-first-time-visitors/) if the old-street choice is really part of a broader evening decision
- read [A Practical 3-Day Chengdu Itinerary for First-Time Visitors](/guides/chengdu-3-day-itinerary/) if you are ready to place the winning choice into an actual short route
