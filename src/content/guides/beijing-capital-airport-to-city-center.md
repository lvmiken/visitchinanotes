...
whoItsFor:
  - "travelers landing at Beijing Capital International Airport"
  - "first-time visitors choosing the easiest route to central Beijing"
keyTakeaways:
...
faq:
  ...
  - question: "Is there a train from Beijing Capital Airport to the city?"
    answer: "Yes. The Capital Airport Express connects the airport with the Beijing subway network and is often the cleanest public-transport option for travelers staying near suitable metro connections."
  - question: "How much does a taxi from Beijing Capital Airport to the city usually cost?"
    answer: "Beijing's official transport guide for foreign arrivals says taxi fares to the city generally range from about CNY 60 to 200, depending on distance and route."
---
...
If you do not speak Chinese, Didi can still work very well, but only if the app, phone number, and payment are already ready. That is why [How to Use Didi in China Without Speaking Chinese](/topics/how-to-use-didi-in-china/) matters.
