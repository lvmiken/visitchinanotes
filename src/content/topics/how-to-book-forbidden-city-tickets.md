---
title: "How to Book Forbidden City Tickets: Foreigner Guide for First-Time Visitors"
description: "Learn how to book Forbidden City tickets with a passport, when tickets go on sale, which official site to use, and how to avoid sold-out dates or booking mistakes."
...
faq:
  ...
  - question: "When do Forbidden City tickets go on sale?"
    answer: "The Palace Museum's official booking system says tickets are released at 20:00, seven days before the visit date."
  - question: "Can I buy same-day Forbidden City tickets?"
    answer: "Official Palace Museum rules say same-day tickets are not sold, so travelers should not rely on getting in after arriving without a reservation."
---
...
- can I reserve with a passport?
- when do tickets go on sale?
- which official channel should I trust?
...
- use the **official Palace Museum reservation system**
- watch for tickets at **20:00 Beijing time, seven days before the visit**
- enter passport details carefully
- bring the **original passport** used for booking
- do not assume same-day tickets will save you
...
- [Palace Museum ticket booking](https://bookingticket.dpm.org.cn/)
...
- which day you use for the historical core
- when that day begins
- how much else you can pack around it
...
- the exact passport number
- the exact name format you use
- using the same valid document for both reservation and entry
...
- **admission starts at 8:30**
- **last admission is 16:00**
- the **morning session checks tickets by 12:00 noon**
- the **afternoon session starts ticket checks at 11:00**
...
- create or verify the account early
- prepare the visitor details in advance
- do not wait until the release minute to start figuring out the system
...
- the historical core is a priority
- your Beijing stop is short
- you are also trying to fit Tiananmen or other nearby landmarks into the same day
...
- trusting unofficial agents first instead of the Palace Museum channel
- forgetting the 20:00 release time seven days ahead
- assuming same-day tickets will still be possible
- entering passport details casually
- bringing a different ID from the one used during reservation
- treating the Forbidden City like a flexible walk-in museum
...
- read [Forbidden City Booking Problems: What Foreign Visitors Usually Get Stuck On](/guides/forbidden-city-booking-problems-what-foreign-visitors-usually-get-stuck-on/) if the official rules make sense but the real-world friction still feels messy
