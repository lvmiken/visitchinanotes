---
title: "Can Tourists Use Alipay in China? A Step-by-Step Setup Guide"
description: "A detailed Alipay setup guide for foreign tourists visiting China, including what to prepare, how to add a card, what usually works on the ground, and how to avoid common payment problems."
publishDate: 2026-06-17
updatedDate: 2026-06-17
planningMoment: "solve-basics"
whenToRead: "Best read before departure, especially if you want mobile payment working before the first airport, metro, or meal purchase in China."
affectsCities:
  - "Beijing"
  - "Shanghai"
  - "Guangzhou"
...
faq:
  ...
  - question: "Should travelers rely only on Alipay in China?"
    answer: "No. Alipay can be a strong main payment tool, but a backup card, some cash, or a second wallet option still makes the trip safer."
  - question: "Is Alipay setup better done before or after arrival?"
...
That is why payment preparation should sit in the same planning sequence as [Airport to City in China: What First-Time Travelers Should Expect](/topics/airport-to-city/) and [Metro, Taxi, and Ride-Hailing in China: What First-Time Travelers Should Expect](/topics/metro-taxi-ridehailing/).
...
You can also keep the broader parent page [How Foreign Tourists Can Use Alipay and WeChat Pay in China](/topics/alipay-wechat-pay/) open if you want to compare Alipay with the bigger China payments picture rather than solving only one wallet.
