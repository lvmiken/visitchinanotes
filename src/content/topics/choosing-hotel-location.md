...
featuredCitySlugs:
  ...
  - "xian"
keyTakeaways:
  - "The best hotel area is the one that supports your most important daily movements."
  - "A famous neighborhood is not always the most useful base for a first trip."
  - "Hotel choice should serve the route, not become a separate puzzle after everything else is booked."
beforeYouBookChecklist:
  - "List the two or three daily movements that matter most in that city."
  - "Choose a base that makes arrival, evenings, and your main sightseeing days easier."
  - "Avoid booking a hotel only because the map makes it look central."
relatedGuideSlugs:
